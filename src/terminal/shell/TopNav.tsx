      ...
      <div className="ml-auto flex items-center gap-1.5" style={{ WebkitAppRegion: 'no-drag' } as React.CSSProperties}>
        ...
        {typeof window !== 'undefined' && window.api?.isElectron && (
          <div className="flex items-center gap-1 ml-1.5 border-l border-(--color-term-border) pl-2" style={{ WebkitAppRegion: 'no-drag' } as React.CSSProperties}>
            <button onClick={() => window.api?.minimize()} className="p-1.5 hover:text-white transition-colors text-zinc-500 hover:bg-white/5 rounded-sm">
              <svg width="12" height="12" viewBox="0 0 12 12"><rect fill="currentColor" width="10" height="1" x="1" y="6"></rect></svg>
            </button>
            <button onClick={() => window.api?.maximize()} className="p-1.5 hover:text-white transition-colors text-zinc-500 hover:bg-white/5 rounded-sm">
              <svg width="12" height="12" viewBox="0 0 12 12"><rect width="9" height="9" x="1.5" y="1.5" fill="none" stroke="currentColor"></rect></svg>
            </button>
            <button onClick={() => window.api?.close()} className="p-1.5 hover:bg-red-500 hover:text-white transition-colors text-zinc-500 rounded-sm">
