    ...
    <div className="space-y-4">
      <div className="bg-violet-600/10 border border-violet-500/30 p-4 rounded-sm flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-[11px] font-bold text-white uppercase tracking-wider">Auto-Optimizer</div>
        ...
        >
          ...
          {scanning ? 'SCANNING...' : 'SCAN FOR EVOLUTION'}
        </button>
      </div>
        ...
        <div className="border border-emerald-500/30 bg-emerald-500/5 rounded-sm p-4 space-y-4 animate-in fade-in slide-in-from-top-2">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-2 bg-black/40 rounded border border-white/5">
              <div className="text-[8px] text-white/30 uppercase mb-2">目前配置</div>
              <div className="text-[10px] text-white/60 space-y-1 font-mono">
                <div>RSI: {proposal.originalParams.RSI_REVERSION?.period}</div>
                <div>SL: {proposal.originalParams.stopLossPct}%</div>
                <div>TP: {proposal.originalParams.takeProfitPct}%</div>
              </div>
            </div>
            <div className="p-2 bg-emerald-500/10 rounded border border-emerald-500/20 relative overflow-hidden">
              ...
              <div className="text-[8px] text-emerald-400/50 uppercase mb-2">建議配置</div>
              <div className="text-[10px] text-emerald-300 space-y-1 font-mono">
                <div>RSI: <span className="font-bold underline">{proposal.betterParams.RSI_REVERSION?.period}</span></div>
                <div>SL: <span className="font-bold underline">{proposal.betterParams.stopLossPct}%</span></div>
                <div>TP: <span className="font-bold underline">{proposal.betterParams.takeProfitPct}%</span></div>
              </div>
            </div>
          </div>
